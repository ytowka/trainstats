    ...
    Box(
        ...
        AnimatedVisibility(
            ...
            Fab(
                ...
                contentDescription = stringResource(SharedRes.string.scroll_to_top),
                onClick = {
                    scope.launch {
                        onScrollToTop()
                    }
...
fun TopBar(
    ...
    Card(
        ...
        GenericTextFiled(
            ...
            hint = stringResource(SharedRes.string.history),
            contentStart = {
        ...
        Row(
            ...
            LargeButton(
                ...
                contentDescription = stringResource(SharedRes.string.new_workout),
            ...
            LargeButton(
                ...
                contentDescription = stringResource(SharedRes.string.calendar),
