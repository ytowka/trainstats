...
val MainNavigationItem.icon: Painter
    @Composable
    get() = org.jetbrains.compose.resources.painterResource(
        when (this) {
...
val MainNavigationItem.label: String
    ...
    get() = stringResource(
        id = when (this) {
            MainNavigationItem.HOME -> R.string.navigation_item_home
            MainNavigationItem.EXERCISES -> R.string.navigation_item_exercises
            //NavigationItem.WORKOUTS -> R.string.navigation_item_workouts
            //NavigationItem.STATS -> R.string.navigation_item_stats
            MainNavigationItem.PROFILE -> R.string.navigation_item_profile
        }
    )
